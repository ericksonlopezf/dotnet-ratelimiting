...
$packageMap = [ordered]@{
    "Core" = @{
        patterns = @("src/EricksonLopez.RateLimiting/", "tests/EricksonLopez.RateLimiting.Tests/")
        config = "stryker-core-config.json"
        outputDir = "StrykerOutput/core"
        artifact = "stryker-report-core"
    }
    "AspNetCore" = @{
        patterns = @("src/EricksonLopez.RateLimiting.AspNetCore/", "tests/EricksonLopez.RateLimiting.AspNetCore.Tests/")
        config = "stryker-aspnetcore-config.json"
        outputDir = "StrykerOutput/aspnetcore"
        artifact = "stryker-report-aspnetcore"
    }
    "Redis" = @{
        patterns = @("src/EricksonLopez.RateLimiting.Redis/", "tests/EricksonLopez.RateLimiting.Redis.Tests/")
...
$globalTriggers = @("Directory.Build.props", "Directory.Packages.props", "EricksonLopez.RateLimiting.slnx", ".editorconfig")
